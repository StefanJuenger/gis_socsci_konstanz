...
Normalization is the process of creating spatial weights. There is a huge dispute on how to do it (Neumayer & Plümper, 2016). But nobody questions whether it should be done in the first place since, among others, it restricts the parameter space of the weights to -1 and +1 and doesn't blow up our estimates.
