...
You could either use the `sdep` package with its function `spdep::poly2nb()` or the more modern approach of the `sfdep` package using the `sfdep::st_contiguity()`. In both cases you have to set the option `queen = FALSE` .
```
